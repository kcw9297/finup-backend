...
public interface StockChartAiService {
    ...
    StockChartDto.ChartAi getChartAi(String code, CandleType candleType, StockChartDto.AiInput input);
    void refreshChartAi(String code, CandleType candleType, StockChartDto.AiInput input);
}
