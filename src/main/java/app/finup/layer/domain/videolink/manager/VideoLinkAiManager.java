...
public interface VideoLinkAiManager {
     ...
     */
    String recommendKeywordsForHome();
     ...
     * @return AI가 생성한 답변 문자열 (JSON 아님)
     */
    String recommendKeywordsForHome(String prevKeywords);
     ...
     * @return AI가 생성한 답변 문자열 (JSON 아님)
     */
    String recommendKeywordsForStudy();
     ...
     * @return AI가 생성한 답변 문자열 (JSON 아님)
     */
    String recommendKeywordsForStudy(String prevKeywords);
