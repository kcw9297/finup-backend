...
public class PromptTemplates {
    ...
    public static final String NEWS_ANALYSIS_DEEP = """
        ...
        1) summary
        - 기사 핵심 내용을 5~7줄로 요약
        - 반드시 [후보 금융 용어] 중 선택된 키워드들을 문장 속에서 자연스럽게 언급할 것
        - 단순 나열이 아닌, “왜 이 개념이 이번 뉴스에서 중요한지”가 드러나게 작성
        ...
        - 각 키워드가 실제 투자자/사용자에게 어떤 의미를 가지는지 연결 설명
        - 지나친 투자 조언, 매수/매도 표현 금지
        - 한 문단(5~7줄)로 작성
        - summary에서 언급된 핵심 키워드들을 다시 활용해 해설
        - “이 뉴스 → 이 개념 → 독자가 이해해야 할 포인트” 흐름이 드러나게 작성
