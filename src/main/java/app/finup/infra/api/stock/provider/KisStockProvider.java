...
import app.finup.infra.api.stock.dto.StockApiDtoMapper;
import app.finup.infra.api.stock.enums.CandleType;
import app.finup.infra.api.stock.utils.KisParamBuilder;
...
public class KisStockProvider implements StockProvider {
    ...
    public StockApiDto.Issue issueToken() {
        ...
        return kisAuthClient.post()
                ...
                // [3] 토큰 존재 검증
                .map(json -> StrUtils.fromJson(json, StockApiDto.IssueApiRp.class)) // JSON 형태 그대로 DTO로 변환
